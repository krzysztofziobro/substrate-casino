...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("node-casino"),
	impl_name: create_runtime_str!("node-casino"),
	authoring_version: 1,
...
impl pallet_casino::Config for Runtime {
}
